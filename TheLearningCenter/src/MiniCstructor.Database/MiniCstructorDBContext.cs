...
{
    public partial class MiniCstructorDBContext : DbContext
    {
        public MiniCstructorDBContext()
        {
        }

        public MiniCstructorDBContext(DbContextOptions<MiniCstructorDBContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=(local);Initial Catalog=MiniCstructorDB;integrated security=True");
            }
        }
